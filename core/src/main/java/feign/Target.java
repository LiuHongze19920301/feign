 ...
 * <br>
 * <p>
 * Target代表了一个服务的地址，包括服务的协议、主机名、端口号、路径等信息。 <br>
 * 表示了对使用Feign相关注解的接口信息 Similar to {@code
...
public interface Target<T> {
     ...
     * <p>
     * 将模版(RequestTempalte)应用到Target上，添加{@link #url() base url}和任何特定于目标的头或查询参数。 <br>
     * For example: <br>
     *
     * <pre>
    ...
    public static class HardCodedTarget<T> implements Target<T> {
        ...
        /**
         * 根据name 和 url是否相同进行toString方法书写
         */
        @Override
