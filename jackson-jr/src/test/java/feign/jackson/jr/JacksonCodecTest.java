...
public class JacksonCodecTest {
    ...
    public void encodesFormParams() {
        ...
        RequestTemplate template = new RequestTemplate();
        new JacksonJrEncoder().encode(form, new TypeReference<Map<String, ?>>() {
        }.getType(), template);
    ...
    public void decodes() throws Exception {
        ...
        Response response = Response.builder()
                ...
                .build();
        assertEquals(zones,
                new JacksonJrDecoder().decode(response, new TypeReference<List<Zone>>() {
                }.getType()));
    }
    ...
    public void customDecoder() throws Exception {
        ...
        Response response = Response.builder()
                ...
                .build();
        assertEquals(dates,
                decoder.decode(response, new TypeReference<List<LocalDate>>() {
                }.getType()));
    }
    ...
    public void customEncoder() {
        ...
        RequestTemplate template = new RequestTemplate();
        encoder.encode(dates, new TypeReference<List<LocalDate>>() {
        }.getType(), template);
    ...
    public void decodesToMap() throws Exception {
        ...
        Map<String, Object> map = (Map<String, Object>) new JacksonJrDecoder()
                .decode(response, new TypeReference<Map<String, Object>>() {
                }.getType());
